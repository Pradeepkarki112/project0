      ...
      <div className="relative flex flex-col items-center gap-[25px] p-[25px] rounded-lg border-White border-[1.88px]">
        ...
        <div className="flex justify-between text-White gap-[45px]">
          <div className="flex gap-[10px] justify-between items-center">
            ...
            <div className="font-bold text-[14px] leading-[15.51px]">
              Forgot Password ?
            </div>
          </div>
          <div className="flex gap-[10px] justify-between items-center">
        ...
        <div className="w-[228px] flex gap-[37px] px-[15px] py-[10px] bg-White/50 rounded-md">
          <div class="flex items-center gap-[15px]">
            <div className="w-6 h-6 border-White border-[1px] rounded-sm"></div>
            <span className="text-White font-bold text-[14px] leading-[15.51px]">
              I’m not a robot
            </span>
          </div>
        ...
        <div className="w-[290px] rounded-xl shadow-white bg-BlueColor text-center text-White font-bold text-[23px] leading-[25.48px] py-3">
          Login
        </div>
      </div>
    </div>
